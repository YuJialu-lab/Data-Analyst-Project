...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'),  # Input Property for Report type - Yearly OR Recession Period Statistics
      Input(component_id='select-year', component_property='value')]         # Input Property for year selection - select a specific year
      )
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    # Plot bar chart for average number of vehicles sold during the given year
         # grouping data for plotting.
         # Hint:Use the columns Year and Automobile_Sales
         # NOTE: I think the plot supposed to be about average number of each vehicle sold  during the given year. So it should use Vehicle_Type & Automobile_Sales, instead of Year & Automobile _Sales
